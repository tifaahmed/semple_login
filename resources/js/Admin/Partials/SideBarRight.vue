    ...
    <div>
        ...
        <aside class="app-sidebar sidebar-scroll">
            ...
            <div class="main-sidemenu" style="overflow: scroll;">
                ...
                <ul class="side-menu">
                    <li v-if="super_admin" class="slide">
...
// jwt.User
    export default {
        ...
        data( ) { return {
            user :jwt.User ,
            admin : jwt.User.roles_array.find(element => element == 'admin')  ,
            customer : jwt.User.roles_array.find(element => element == 'customer')  ,
            store : jwt.User.roles_array.find(element => element == 'store')  ,
            super_admin : jwt.User.roles_array.find(element => element == 'super admin')  ,
